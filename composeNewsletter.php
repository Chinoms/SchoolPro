...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-md-3">
                <a href="<?php echo $baseURL . '/newsletterInbox.php' ?>" class="btn btn-primary btn-block margin-bottom">Back to Inbox</a>
                ...
                <div class="box box-solid">
                    ...
                    <div class="box-body no-padding">
                        <ul class="nav nav-pills nav-stacked">
                            <li class="active"><a href="<?php echo $baseURL . '/mailbox.php'; ?>"><i class="fa fa-inbox"></i> Inbox</a></li>
            ...
            <div class="col-md-9">
                <div class="box box-primary">
                    ...
                    <div class="box-body">  
                        ...
                        <div class="form-group">
                            <textarea id="compose-textarea" class="form-control" style="height: 250px" name="msg">
                    ...
                    <div class="box-footer">
                        <div class="pull-right">
                            ...
                            <input type="submit" class="btn btn-primary" value="Send Message" name="sendNewsletter">
                        </div>
