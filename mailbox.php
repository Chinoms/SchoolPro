        ...
        <div class="row">
            ...
            <div class="col-md-9">
				...
				$startFrom = ($page-1) * 5;
                                    ...
                                    //fetch messgage info
                                    $checkMessage = "SELECT * FROM messages WHERE recipient = '$userID' ORDER BY timestamp DESC LIMIT $startFrom, 5";
                    ...
                    <div class="box-footer no-padding">
                        ...
                        <?php
                                    $countMessages = "SELECT COUNT(id) FROM messages WHERE recipient = $userID";
                                    ...
                                    for ($i = 1; $i <= $totalPages; $i++) {
                                        echo "<li class='paginate_button'><a href='mailbox.php?page=" . $i . "' >" . $i . "</a> </li>";
                                    };
                                       echo "</ul>";


                                    if ($_SERVER['PHP_SELF'] = $totalPages) {
                                        echo "<a href='mailbox.php?page=$totalPages'></a> "; // Goto last page
                                    } else {
                                        #echo "LAST";
                                    }
                                    ?>
